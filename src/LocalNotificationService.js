...
import notificationSound from '../android/app/src/main/res/raw/cektokonotif.mp3';
...
class LocalNotificationService {
    ...
    buildAndroidNotification = (id, title, message, data = {}, options = {}) => {
        return {
            id: id,
            autoCancel: true,
            largeIcon: options.largeIcon || "ic_logo_merchant",
            smallIcon: options.smallIcon || "ic_logo_merchant",
            bigText: message || '',
            subText: title || '',
            ...
            data: data,
            playSound: options.playSound || true,
            soundNotif: options.soundName || 'default'
        }
    }
