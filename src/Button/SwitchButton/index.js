        ...
        <View>
            <SwitchButton
               // onValueChange={(val) => this.setState({ activeSwitch: val })}      // this is necessary for this component
                text1 = 'DiKirim'                        // optional: first text in switch button --- default ON
                text2 = 'Ambil Sendiri'                       // optional: second text in switch button --- default OFF
                switchWidth = {200}                 // optional: switch width --- default 44
                switchHeight = {38}                 // optional: switch height --- default 100
